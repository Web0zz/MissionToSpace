...
internal val expectedLaunchesEntity =
    LaunchesEntity(
        id = "5eb87cd9ffd86e000604b32a",
        fairings = FairingsEntity(
            reused = false,
            recoveryAttempt = false,
            recovered = false,
            ships = emptyList()
        ...
        links = LinksEntity(
            patch = LinksEntity.Companion.PatchEntity(
                small = "https://images2.imgbox.com/3c/0e/T8iJcSN3_o.png",
                large = "https://images2.imgbox.com/40/e3/GypSkayF_o.png"
            ),
            reddit = LinksEntity.Companion.RedditEntity(
                campaign = null,
                launch = null,
                media = null,
                recovery = null
            ),
            flickr = LinksEntity.Companion.FlickrEntity(
                small = emptyList(),
                original = emptyList()
            ),
            presskit = null,
